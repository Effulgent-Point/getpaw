...
export const metadata: Metadata = {
  title: "Catalog",
  description:
    "Browse the paw kit: 18 specialized agents, 6 doctrine rules, 7 skill bundles, 4 hooks, and a 15-command CLI. Search everything, or filter agents by phase and permission tier.",
