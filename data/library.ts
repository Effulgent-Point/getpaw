...
// the rest are ideas worth building. Drawn from real workflows we have seen
// on teams that lean on agent harnesses day to day. A menu to steal from,
// not a spec.
...
export const AGENT_IDEAS: AgentIdea[] = [
  ...
  },
  {
    ...
    blurb: "WCAG pass: keyboard, focus, contrast, semantic HTML, and alt text.",
  },
  // Build
  {
    group: "Build",
